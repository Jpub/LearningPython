...
<tr><td bgcolor="%s">%s</td><td>%s</td>''' % (bgcol, marginalia, gap)
    ...
    def docmodule(self, object, name=None, mod=None, *ignored):
        ...
        if classes:
            ...
            result = result + self.bigsection(
                'Classes', '#ffffff', '#008080', ' '.join(contents))
        if funcs:
            contents = []
    ...
    def docclass(self, object, name=None, mod=None, funcs={}, classes={},
        ...
        return self.section(title, '#000000', '#c0c0c0', contents, 3, doc)
    ...
    def index(self, dir, shadowed=None):
        ...
        modpkgs.sort()
        contents = self.multicolumn(modpkgs, self.modpkglink)
        return self.bigsection(dir, '#ffffff', '#008080', contents)
...
%s</head><body bgcolor="#f0f0f8">%s<div style="clear:both;padding-top:.5em;">%s</div>
    ...
    def html_index():
        ...
        contents = [heading, '<p>' + html.bigsection(
            'Built-in Modules', '#ffffff', '#008080', contents)]
    ...
    def html_search(key):
        ...
        contents = heading + html.bigsection(
            'key = %s' % key, '#ffffff', '#008080', '<br>'.join(results))
    ...
    def html_getfile(path):
        ...
        heading = html.heading(
            ...
            '#ffffff', '#7799ee')
        contents = heading + html.bigsection(
            'File: %s' % path, '#ffffff', '#008080', body)
    ...
    def html_keywords():
        ...
        contents = html.multicolumn(names, bltinlink)
        contents = heading + html.bigsection(
            'Keywords', '#ffffff', '#008080', contents)
    ...
    def html_topicpage(topic):
        ...
        contents = html.bigsection(topic , '#ffffff','#008080', contents)
        if xrefs:
